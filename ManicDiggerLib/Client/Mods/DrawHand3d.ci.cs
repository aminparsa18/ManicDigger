...
public class BlockRendererTorch
{
    ...
    public void AddTorch(GameData d_Data, Game d_TerainRenderer, ModelData m, int x, int y, int z, TorchType type)
    {
        ...
        Vector3 top00 = Vector3.Create(topx, z + (one * 9 / 10), topy);
        Vector3 top01 = Vector3.Create(topx, z + (one * 9 / 10), topy + torchsizexy);
        Vector3 top10 = Vector3.Create(topx + torchsizexy, z + (one * 9 / 10), topy);
        Vector3 top11 = Vector3.Create(topx + torchsizexy, z + (one * 9 / 10), topy + torchsizexy);
        ...
        Vector3 bottom00 = Vector3.Create(bottomx, z + 0, bottomy);
        Vector3 bottom01 = Vector3.Create(bottomx, z + 0, bottomy + torchsizexy);
        Vector3 bottom10 = Vector3.Create(bottomx + torchsizexy, z + 0, bottomy);
        Vector3 bottom11 = Vector3.Create(bottomx + torchsizexy, z + 0, bottomy + torchsizexy);
