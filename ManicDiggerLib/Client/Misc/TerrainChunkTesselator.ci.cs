...
public class TerrainChunkTesselatorCi
{
    ...
    public void AddTorch(int x, int y, int z, int type, int tt)
    {
        ...
        Vector3 top00 = Vector3.Create(topx, z + 0.9f, topy);
        Vector3 top01 = Vector3.Create(topx, z + 0.9f, topy + torchsizexy);
        Vector3 top10 = Vector3.Create(topx + torchsizexy, z + 0.9f, topy);
        Vector3 top11 = Vector3.Create(topx + torchsizexy, z + 0.9f, topy + torchsizexy);
